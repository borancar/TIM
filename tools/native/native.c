...
"  TIM_STOP=FRAME          run to that frame and stop, having presented it\n"
"  TIM_NATIVE_LAYERS=WHICH which of the port's layers stand in for the\n"
"                          guest's. Unset or `all` is what this has always\n"
"                          done. `io` is every layer but the game's own code -\n"
"                          the port as the machine, the original as the\n"
"                          program - and a comma-separated list of\n"
"                          vm sx dos mem irq mouse hw game picks any subset.\n"
"                          The layer of each routine is derived, not declared:\n"
"                          see genshims.py. A run that names layers says how\n"
"                          many of the routines it dispatched.\n"
"\n"
