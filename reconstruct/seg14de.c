...
static const struct {
    ...
    uint16_t setup;
    /*
     * Two **byte** stores at +0x6a and +0x6b that four of the forty-three
     * hooks make, between the flag ors and the calloc - `mov byte ptr [si +
     * 0x6a], 0x10` and its neighbour. They were missing from this table
     * entirely, so those four parts got zeros; `tools/verify.py --only
     * make_part` found it as two bytes differing out of 190 changed, with the
     * return value and everything else agreeing.
     *
     * 0xffff means the hook makes no such store, because **0 is a value one
     * of them writes** - 0x143fb, which is one of the five written out by
     * hand in `part_init_special` rather than living here.
     */
    uint16_t b6a;
    uint16_t b6b;
} part_inits[43] = {
    /*    at       +6      +8      +0a     setup    +0x6a   +0x6b */
    { 0x14236, 0x0000, 0x0000, 0x0000, 0x0001, 0xffff, 0xffff },
    { 0x14267, 0x0040, 0x0180, 0x0000, 0x48ab, 0xffff, 0xffff },
    { 0x142a1, 0x0600, 0x0080, 0x0000, 0x2728, 0xffff, 0xffff },
    { 0x142e6, 0x0400, 0x000c, 0x0000, 0x40f0, 0xffff, 0xffff },
    { 0x14320, 0x0020, 0x0004, 0x0000, 0x012d, 0x0010, 0x002f },
    { 0x14361, 0x0000, 0x0081, 0x0000, 0x24d0, 0xffff, 0xffff },
    { 0x143b3, 0x0400, 0x0801, 0x0000, 0x2ee1, 0xffff, 0xffff },
    { 0x1446c, 0x0000, 0x0000, 0x0000, 0x0001, 0xffff, 0xffff },
    { 0x144cb, 0x0020, 0x0004, 0x0000, 0x0f70, 0x0015, 0xffff },
    { 0x1450c, 0x0400, 0x8000, 0x0000, 0x0c1c, 0xffff, 0xffff },
    { 0x14547, 0x0400, 0x1001, 0x0000, 0x295d, 0xffff, 0xffff },
    { 0x1458f, 0x0000, 0x0001, 0x0000, 0x0001, 0xffff, 0xffff },
    { 0x145d1, 0x0000, 0x1000, 0x0000, 0x1be9, 0xffff, 0xffff },
    { 0x14607, 0x0400, 0x0000, 0x0000, 0x0371, 0xffff, 0xffff },
    { 0x1463d, 0x0020, 0x0004, 0x0000, 0x07b2, 0x0012, 0xffff },
    { 0x1467e, 0x0400, 0x1000, 0x0004, 0x0b88, 0xffff, 0xffff },
    { 0x146bd, 0x0420, 0x1000, 0x0004, 0x1261, 0xffff, 0xffff },
    { 0x146fc, 0x0000, 0x0000, 0x0000, 0x08a1, 0xffff, 0xffff },
    { 0x1472d, 0x0200, 0x1000, 0x0002, 0x1556, 0xffff, 0xffff },
    { 0x1476c, 0x0400, 0x1004, 0x0000, 0x3294, 0xffff, 0xffff },
    { 0x147a7, 0x0200, 0x0004, 0x0000, 0x19db, 0xffff, 0xffff },
    { 0x147c5, 0x0400, 0x1000, 0x0001, 0x1a32, 0xffff, 0xffff },
    { 0x14804, 0x0400, 0x0000, 0x0000, 0x1d28, 0xffff, 0xffff },
    { 0x1483a, 0x0000, 0x1001, 0x0002, 0x1dfb, 0xffff, 0xffff },
    { 0x14874, 0x0400, 0x1004, 0x0000, 0x23b1, 0xffff, 0xffff },
    { 0x148af, 0x0000, 0x0000, 0x0000, 0x00c9, 0xffff, 0xffff },
    { 0x148e0, 0x0200, 0x1004, 0x0000, 0x2b58, 0xffff, 0xffff },
    { 0x148ff, 0x0400, 0x0000, 0x0000, 0x3030, 0xffff, 0xffff },
    { 0x14919, 0x0400, 0x1805, 0x0000, 0x2cce, 0xffff, 0xffff },
    { 0x14954, 0x0000, 0x0000, 0x0000, 0x35f4, 0xffff, 0xffff },
    { 0x14985, 0x0020, 0x0004, 0x0000, 0x2682, 0x0012, 0x0023 },
    { 0x149c6, 0x0000, 0x0000, 0x0000, 0x1075, 0xffff, 0xffff },
    { 0x149f7, 0x0400, 0x0000, 0x0000, 0x065b, 0xffff, 0xffff },
    { 0x14a2d, 0x0000, 0x1000, 0x0004, 0x3737, 0xffff, 0xffff },
    { 0x14a67, 0x0400, 0x1000, 0x0000, 0x389b, 0xffff, 0xffff },
    { 0x14ab9, 0x0000, 0x1000, 0x0000, 0x3f72, 0xffff, 0xffff },
    { 0x14aef, 0x0400, 0x0801, 0x0000, 0x496f, 0xffff, 0xffff },
    { 0x14b37, 0x0400, 0x8000, 0x0000, 0x346f, 0xffff, 0xffff },
    { 0x14b72, 0x0000, 0x0000, 0x0000, 0x0065, 0xffff, 0xffff },
    { 0x14ba3, 0x0000, 0x0000, 0x0000, 0x00c9, 0xffff, 0xffff },
    { 0x14bd4, 0x0020, 0x1000, 0x0004, 0x0950, 0xffff, 0xffff },
    { 0x14c12, 0x0600, 0x0000, 0x0000, 0x377b, 0xffff, 0xffff },
    { 0x14c62, 0x0400, 0x0001, 0x0001, 0x1435, 0xffff, 0xffff },
};
...
uint16_t part_init(uint32_t at, uint16_t part)
{
    ...
    for (i = 0; i < 43; i++) {
        ...
        /* After the ors and before the calloc, which is where 0x14320 and
         * 0x14985 put them. */
        if (part_inits[i].b6a != 0xffff)
            DG8((uint16_t)(part + 0x6a)) = (uint8_t)part_inits[i].b6a;
        if (part_inits[i].b6b != 0xffff)
            DG8((uint16_t)(part + 0x6b)) = (uint8_t)part_inits[i].b6b;
