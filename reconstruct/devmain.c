...
"  TIM_TRACE=speaker  trace the PC speaker: the tone and the gate, as\n"
"                  the game's own driver programs the 8253 and 0x61\n"
"  TIM_TRACE=sb      trace the Sound Blaster: DSP commands, resets,\n"
"                  and each DMA block handed over with its rate\n"
