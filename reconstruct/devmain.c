...
"  TIM_LUA=PORT    listen on 127.0.0.1:PORT and run what is sent as Lua,\n"
"                  a line at a time, inside the game. A script can look at\n"
"                  DGROUP before it clicks and wait for page flips, which\n"
"                  TIM_CLICK's flip-numbered clicks cannot. See devlua.c\n"
