 ...
 *
 * **The hooks are far pointers the loader relocates**, and these are the words
 * before it does: segment 0000 for the do-nothing routines at 0x0297..0x02b5,
 * segment 172c for the rest. They are exactly the relocation table's entries
 * in this range, six a record and nothing else, so `load_part_kinds` adds the
 * load segment to every `seg` and to no other field. The routine each names is
 * the port's transcription at that address.
 *
 ...
 * they are.
 */
static const struct part_kind PART_KINDS_IMAGE[PART_KIND_COUNT] = {
    [KIND_BOWLING_BALL] = {    /* DGROUP 0x0ea6 */
        ...
        .hit    = { 0x0297, 0x0000 },    /* part_hook_yes */
        .step   = { 0x02a1, 0x0000 },    /* part_hook_none_2a1 */
        .setup  = { 0x0001, 0x172c },    /* part_setup_0001 */
        .flip   = { 0x02ab, 0x0000 },    /* part_hook_none_2ab */
        .settle = { 0x02b0, 0x0000 },    /* part_hook_none_2b0 */
        .drive  = { 0x02b5, 0x0000 },    /* part_hook_no */
    },
    [KIND_BRICK_PLATFORM] = {    /* DGROUP 0x0ee0 */
        ...
        .hit    = { 0x0297, 0x0000 },    /* part_hook_yes */
        .step   = { 0x02a1, 0x0000 },    /* part_hook_none_2a1 */
        .setup  = { 0x48ab, 0x172c },    /* part_setup_48ab */
        .flip   = { 0x02ab, 0x0000 },    /* part_hook_none_2ab */
        .settle = { 0x48f7, 0x172c },    /* part_settle_48f7 */
        .drive  = { 0x02b5, 0x0000 },    /* part_hook_no */
    },
    [KIND_RAMP] = {    /* DGROUP 0x0f1a */
        ...
        .hit    = { 0x0297, 0x0000 },    /* part_hook_yes */
        .step   = { 0x02a1, 0x0000 },    /* part_hook_none_2a1 */
        .setup  = { 0x2728, 0x172c },    /* part_setup_ramp */
        .flip   = { 0x27b6, 0x172c },    /* part_flip_ramp */
        .settle = { 0x2789, 0x172c },    /* part_settle_ramp */
        .drive  = { 0x02b5, 0x0000 },    /* part_hook_no */
    },
    [KIND_SEESAW] = {    /* DGROUP 0x0f54 */
        ...
        .hit    = { 0x3fe8, 0x172c },    /* part_hit_seesaw */
        .step   = { 0x420f, 0x172c },    /* part_step_seesaw */
        .setup  = { 0x40f0, 0x172c },    /* part_setup_seesaw */
        .flip   = { 0x41bb, 0x172c },    /* part_flip_seesaw */
        .settle = { 0x02b0, 0x0000 },    /* part_hook_none_2b0 */
        .drive  = { 0x44fe, 0x172c },    /* part_drive_44fe */
    },
    [KIND_BALLOON] = {    /* DGROUP 0x0f8e */
        ...
        .hit    = { 0x016e, 0x172c },    /* part_hit_balloon */
        .step   = { 0x018e, 0x172c },    /* part_step_balloon */
        .setup  = { 0x012d, 0x172c },    /* part_setup_balloon */
        .flip   = { 0x02ab, 0x0000 },    /* part_hook_none_2ab */
        .settle = { 0x02b0, 0x0000 },    /* part_hook_none_2b0 */
        .drive  = { 0x02cd, 0x172c },    /* part_drive_02cd */
    },
    [KIND_CONVEYOR] = {    /* DGROUP 0x0fc8 */
        ...
        .hit    = { 0x2514, 0x172c },    /* part_hit_conveyor */
        .step   = { 0x2592, 0x172c },    /* part_step_conveyor */
        .setup  = { 0x24d0, 0x172c },    /* part_setup_conveyor */
        .flip   = { 0x02ab, 0x0000 },    /* part_hook_none_2ab */
        .settle = { 0x261d, 0x172c },    /* part_settle_conveyor */
        .drive  = { 0x02b5, 0x0000 },    /* part_hook_no */
    },
    [KIND_MOUSE_CAGE] = {    /* DGROUP 0x1002 */
        ...
        .hit    = { 0x2f25, 0x172c },    /* part_hit_mouse_cage */
        .step   = { 0x2f3e, 0x172c },    /* part_step_mouse_cage */
        .setup  = { 0x2ee1, 0x172c },    /* part_setup_mouse_cage */
        .flip   = { 0x2fba, 0x172c },    /* part_flip_mouse_cage */
        .settle = { 0x02b0, 0x0000 },    /* part_hook_none_2b0 */
        .drive  = { 0x02b5, 0x0000 },    /* part_hook_no */
    },
    [KIND_PULLEY] = {    /* DGROUP 0x103c */
        ...
        .hit    = { 0x0297, 0x0000 },    /* part_hook_yes */
        .step   = { 0x02a1, 0x0000 },    /* part_hook_none_2a1 */
        .setup  = { 0x02a6, 0x0000 },    /* part_hook_none_2a6 */
        .flip   = { 0x02ab, 0x0000 },    /* part_hook_none_2ab */
        .settle = { 0x02b0, 0x0000 },    /* part_hook_none_2b0 */
        .drive  = { 0x02b5, 0x0000 },    /* part_hook_no */
    },
    ...
    [KIND_BIRD_CAGE] = {    /* DGROUP 0x1124 */
        ...
        .hit    = { 0x0297, 0x0000 },    /* part_hook_yes */
        .step   = { 0x02a1, 0x0000 },    /* part_hook_none_2a1 */
        .setup  = { 0x0f70, 0x172c },    /* part_setup_bird_cage */
        .flip   = { 0x02ab, 0x0000 },    /* part_hook_none_2ab */
        .settle = { 0x02b0, 0x0000 },    /* part_hook_none_2b0 */
        .drive  = { 0x0ffc, 0x172c },    /* part_drive_0ffc */
    },
    [KIND_POKEY] = {    /* DGROUP 0x115e */
        ...
        .hit    = { 0x0c6c, 0x172c },    /* part_hit_pokey */
        .step   = { 0x0ca3, 0x172c },    /* part_step_pokey */
        .setup  = { 0x0c1c, 0x172c },    /* part_setup_pokey */
        .flip   = { 0x0f3d, 0x172c },    /* part_flip_pokey */
        .settle = { 0x02b0, 0x0000 },    /* part_hook_none_2b0 */
        .drive  = { 0x02b5, 0x0000 },    /* part_hook_no */
    },
    [KIND_JACK_IN_THE_BOX] = {    /* DGROUP 0x1198 */
        ...
        .hit    = { 0x0297, 0x0000 },    /* part_hook_yes */
        .step   = { 0x27e2, 0x172c },    /* part_step_jack_in_the_box */
        .setup  = { 0x295d, 0x172c },    /* part_setup_jack_in_the_box */
        .flip   = { 0x2999, 0x172c },    /* part_flip_jack_in_the_box */
        .settle = { 0x02b0, 0x0000 },    /* part_hook_none_2b0 */
        .drive  = { 0x02b5, 0x0000 },    /* part_hook_no */
    },
    [KIND_GEAR] = {    /* DGROUP 0x11d2 */
        ...
        .hit    = { 0x1f78, 0x172c },    /* part_hit_gear */
        .step   = { 0x20fc, 0x172c },    /* part_step_gear */
        .setup  = { 0x2068, 0x172c },    /* part_setup_gear */
        .flip   = { 0x02ab, 0x0000 },    /* part_hook_none_2ab */
        .settle = { 0x02b0, 0x0000 },    /* part_hook_none_2b0 */
        .drive  = { 0x02b5, 0x0000 },    /* part_hook_no */
    },
    [KIND_BOB_THE_FISH] = {    /* DGROUP 0x120c */
        ...
        .hit    = { 0x1c39, 0x172c },    /* part_hit_bob_the_fish */
        .step   = { 0x1c5f, 0x172c },    /* part_step_bob_the_fish */
        .setup  = { 0x1be9, 0x172c },    /* part_setup_bob_the_fish */
        .flip   = { 0x02ab, 0x0000 },    /* part_hook_none_2ab */
        .settle = { 0x02b0, 0x0000 },    /* part_hook_none_2b0 */
        .drive  = { 0x02b5, 0x0000 },    /* part_hook_no */
    },
    [KIND_BELLOW] = {    /* DGROUP 0x1246 */
        ...
        .hit    = { 0x0332, 0x172c },    /* part_hit_bellow */
        .step   = { 0x0405, 0x172c },    /* part_step_bellow */
        .setup  = { 0x0371, 0x172c },    /* part_setup_bellow */
        .flip   = { 0x03d2, 0x172c },    /* part_flip_bellow */
        .settle = { 0x02b0, 0x0000 },    /* part_hook_none_2b0 */
        .drive  = { 0x02b5, 0x0000 },    /* part_hook_no */
    },
    [KIND_BUCKET] = {    /* DGROUP 0x1280 */
        ...
        .hit    = { 0x0763, 0x172c },    /* part_hit_bucket */
        .step   = { 0x02a1, 0x0000 },    /* part_hook_none_2a1 */
        .setup  = { 0x07b2, 0x172c },    /* part_setup_bucket */
        .flip   = { 0x02ab, 0x0000 },    /* part_hook_none_2ab */
        .settle = { 0x02b0, 0x0000 },    /* part_hook_none_2b0 */
        .drive  = { 0x0802, 0x172c },    /* part_drive_0802 */
    },
    [KIND_CANNON] = {    /* DGROUP 0x12ba */
        ...
        .hit    = { 0x0297, 0x0000 },    /* part_hook_yes */
        .step   = { 0x0a5d, 0x172c },    /* part_step_cannon */
        .setup  = { 0x0b88, 0x172c },    /* part_setup_cannon */
        .flip   = { 0x0be9, 0x172c },    /* part_flip_cannon */
        .settle = { 0x02b0, 0x0000 },    /* part_hook_none_2b0 */
        .drive  = { 0x02b5, 0x0000 },    /* part_hook_no */
    },
    [KIND_DYNAMITE] = {    /* DGROUP 0x12f4 */
        ...
        .hit    = { 0x1237, 0x172c },    /* part_hit_dynamite */
        .step   = { 0x12c2, 0x172c },    /* part_step_dynamite */
        .setup  = { 0x1261, 0x172c },    /* part_setup_dynamite */
        .flip   = { 0x12fc, 0x172c },    /* part_flip_dynamite */
        .settle = { 0x02b0, 0x0000 },    /* part_hook_none_2b0 */
        .drive  = { 0x02b5, 0x0000 },    /* part_hook_no */
    },
    [KIND_BULLET] = {    /* DGROUP 0x132e */
        ...
        .hit    = { 0x0867, 0x172c },    /* part_hit_0867 */
        .step   = { 0x08f1, 0x172c },    /* part_step_08f1 */
        .setup  = { 0x08a1, 0x172c },    /* part_setup_08a1 */
        .flip   = { 0x02ab, 0x0000 },    /* part_hook_none_2ab */
        .settle = { 0x02b0, 0x0000 },    /* part_hook_none_2b0 */
        .drive  = { 0x02b5, 0x0000 },    /* part_hook_no */
    },
    [KIND_ELECTRIC_PLUG] = {    /* DGROUP 0x1368 */
        ...
        .hit    = { 0x14d3, 0x172c },    /* part_hit_electric_plug */
        .step   = { 0x15ce, 0x172c },    /* part_step_electric_plug */
        .setup  = { 0x1556, 0x172c },    /* part_setup_electric_plug */
        .flip   = { 0x15fc, 0x172c },    /* part_flip_electric_plug */
        .settle = { 0x02b0, 0x0000 },    /* part_hook_none_2b0 */
        .drive  = { 0x02b5, 0x0000 },    /* part_hook_no */
    },
    [KIND_DYNAMITE_PLUNGER] = {    /* DGROUP 0x13a2 */
        ...
        .hit    = { 0x323f, 0x172c },    /* part_hit_dynamite_plunger */
        .step   = { 0x332a, 0x172c },    /* part_step_dynamite_plunger */
        .setup  = { 0x3294, 0x172c },    /* part_setup_dynamite_plunger */
        .flip   = { 0x33e5, 0x172c },    /* part_flip_dynamite_plunger */
        .settle = { 0x02b0, 0x0000 },    /* part_hook_none_2b0 */
        .drive  = { 0x341d, 0x172c },    /* part_drive_341d */
    },
    [KIND_HOOK] = {    /* DGROUP 0x13dc */
        ...
        .hit    = { 0x0297, 0x0000 },    /* part_hook_yes */
        .step   = { 0x02a1, 0x0000 },    /* part_hook_none_2a1 */
        .setup  = { 0x19db, 0x172c },    /* part_setup_hook */
        .flip   = { 0x19fa, 0x172c },    /* part_flip_hook */
        .settle = { 0x02b0, 0x0000 },    /* part_hook_none_2b0 */
        .drive  = { 0x02b5, 0x0000 },    /* part_hook_no */
    },
    [KIND_FAN] = {    /* DGROUP 0x1416 */
        ...
        .hit    = { 0x0297, 0x0000 },    /* part_hook_yes */
        .step   = { 0x1a82, 0x172c },    /* part_step_fan */
        .setup  = { 0x1a32, 0x172c },    /* part_setup_fan */
        .flip   = { 0x1bbd, 0x172c },    /* part_flip_fan */
        .settle = { 0x02b0, 0x0000 },    /* part_hook_none_2b0 */
        .drive  = { 0x02b5, 0x0000 },    /* part_hook_no */
    },
    [KIND_FLASHLIGHT] = {    /* DGROUP 0x1450 */
        ...
        .hit    = { 0x1d07, 0x172c },    /* part_hit_flashlight */
        .step   = { 0x1d78, 0x172c },    /* part_step_flashlight */
        .setup  = { 0x1d28, 0x172c },    /* part_setup_flashlight */
        .flip   = { 0x1da8, 0x172c },    /* part_flip_flashlight */
        .settle = { 0x02b0, 0x0000 },    /* part_hook_none_2b0 */
        .drive  = { 0x02b5, 0x0000 },    /* part_hook_no */
    },
    [KIND_GENERATOR] = {    /* DGROUP 0x148a */
        ...
        .hit    = { 0x1de0, 0x172c },    /* part_hit_generator */
        .step   = { 0x1e5c, 0x172c },    /* part_step_generator */
        .setup  = { 0x1dfb, 0x172c },    /* part_setup_generator */
        .flip   = { 0x02ab, 0x0000 },    /* part_hook_none_2ab */
        .settle = { 0x02b0, 0x0000 },    /* part_hook_none_2b0 */
        .drive  = { 0x02b5, 0x0000 },    /* part_hook_no */
    },
    [KIND_GUN] = {    /* DGROUP 0x14c4 */
        ...
        .hit    = { 0x0297, 0x0000 },    /* part_hook_yes */
        .step   = { 0x22ae, 0x172c },    /* part_step_gun */
        .setup  = { 0x23b1, 0x172c },    /* part_setup_gun */
        .flip   = { 0x2412, 0x172c },    /* part_flip_gun */
        .settle = { 0x02b0, 0x0000 },    /* part_hook_none_2b0 */
        .drive  = { 0x2451, 0x172c },    /* part_drive_2451 */
    },
    [KIND_BASEBALL] = {    /* DGROUP 0x14fe */
        ...
        .hit    = { 0x0297, 0x0000 },    /* part_hook_yes */
        .step   = { 0x02a1, 0x0000 },    /* part_hook_none_2a1 */
        .setup  = { 0x00c9, 0x172c },    /* part_setup_00c9 */
        .flip   = { 0x02ab, 0x0000 },    /* part_hook_none_2ab */
        .settle = { 0x02b0, 0x0000 },    /* part_hook_none_2b0 */
        .drive  = { 0x02b5, 0x0000 },    /* part_hook_no */
    },
    [KIND_LIGHT] = {    /* DGROUP 0x1538 */
        ...
        .hit    = { 0x2b7e, 0x172c },    /* part_hit_light */
        .step   = { 0x2b99, 0x172c },    /* part_step_light */
        .setup  = { 0x2b58, 0x172c },    /* part_setup_light */
        .flip   = { 0x2bc5, 0x172c },    /* part_flip_light */
        .settle = { 0x02b0, 0x0000 },    /* part_hook_none_2b0 */
        .drive  = { 0x2c19, 0x172c },    /* part_drive_2c19 */
    },
    [KIND_MAGNIFYING_GLASS] = {    /* DGROUP 0x1572 */
        ...
        .hit    = { 0x0297, 0x0000 },    /* part_hook_yes */
        .step   = { 0x3035, 0x172c },    /* part_step_magnifying_glass */
        .setup  = { 0x3030, 0x172c },    /* part_setup_magnifying_glass */
        .flip   = { 0x31af, 0x172c },    /* part_flip_magnifying_glass */
        .settle = { 0x02b0, 0x0000 },    /* part_hook_none_2b0 */
        .drive  = { 0x02b5, 0x0000 },    /* part_hook_no */
    },
    [KIND_MONKEY] = {    /* DGROUP 0x15ac */
        ...
        .hit    = { 0x2c83, 0x172c },    /* part_hit_monkey */
        .step   = { 0x2d40, 0x172c },    /* part_step_monkey */
        .setup  = { 0x2cce, 0x172c },    /* part_setup_monkey */
        .flip   = { 0x2e0c, 0x172c },    /* part_flip_monkey */
        .settle = { 0x02b0, 0x0000 },    /* part_hook_none_2b0 */
        .drive  = { 0x2e4b, 0x172c },    /* part_drive_2e4b */
    },
    [KIND_PUMPKIN] = {    /* DGROUP 0x15e6 */
        ...
        .hit    = { 0x0297, 0x0000 },    /* part_hook_yes */
        .step   = { 0x02a1, 0x0000 },    /* part_hook_none_2a1 */
        .setup  = { 0x35f4, 0x172c },    /* part_setup_pumpkin */
        .flip   = { 0x02ab, 0x0000 },    /* part_hook_none_2ab */
        .settle = { 0x02b0, 0x0000 },    /* part_hook_none_2b0 */
        .drive  = { 0x02b5, 0x0000 },    /* part_hook_no */
    },
    [KIND_HEART_BALLOON] = {    /* DGROUP 0x1620 */
        ...
        .hit    = { 0x0297, 0x0000 },    /* part_hook_yes */
        .step   = { 0x02a1, 0x0000 },    /* part_hook_none_2a1 */
        .setup  = { 0x2682, 0x172c },    /* part_setup_heart_balloon */
        .flip   = { 0x02ab, 0x0000 },    /* part_hook_none_2ab */
        .settle = { 0x02b0, 0x0000 },    /* part_hook_none_2b0 */
        .drive  = { 0x26c3, 0x172c },    /* part_drive_26c3 */
    },
    [KIND_CHRISTMAS_TREE] = {    /* DGROUP 0x165a */
        ...
        .hit    = { 0x0297, 0x0000 },    /* part_hook_yes */
        .step   = { 0x02a1, 0x0000 },    /* part_hook_none_2a1 */
        .setup  = { 0x1075, 0x172c },    /* part_setup_christmas_tree */
        .flip   = { 0x02ab, 0x0000 },    /* part_hook_none_2ab */
        .settle = { 0x02b0, 0x0000 },    /* part_hook_none_2b0 */
        .drive  = { 0x02b5, 0x0000 },    /* part_hook_no */
    },
    [KIND_BOXING_GLOVE] = {    /* DGROUP 0x1694 */
        ...
        .hit    = { 0x0552, 0x172c },    /* part_hit_boxing_glove */
        .step   = { 0x057e, 0x172c },    /* part_step_boxing_glove */
        .setup  = { 0x065b, 0x172c },    /* part_setup_boxing_glove */
        .flip   = { 0x06c6, 0x172c },    /* part_flip_boxing_glove */
        .settle = { 0x02b0, 0x0000 },    /* part_hook_none_2b0 */
        .drive  = { 0x02b5, 0x0000 },    /* part_hook_no */
    },
    [KIND_ROCKET] = {    /* DGROUP 0x16ce */
        ...
        .hit    = { 0x0297, 0x0000 },    /* part_hook_yes */
        .step   = { 0x3635, 0x172c },    /* part_step_rocket */
        .setup  = { 0x3737, 0x172c },    /* part_setup_rocket */
        .flip   = { 0x02ab, 0x0000 },    /* part_hook_none_2ab */
        .settle = { 0x02b0, 0x0000 },    /* part_hook_none_2b0 */
        .drive  = { 0x02b5, 0x0000 },    /* part_hook_no */
    },
    [KIND_SCISSORS] = {    /* DGROUP 0x1708 */
        ...
        .hit    = { 0x3824, 0x172c },    /* part_hit_scissors */
        .step   = { 0x38fc, 0x172c },    /* part_step_scissors */
        .setup  = { 0x389b, 0x172c },    /* part_setup_scissors */
        .flip   = { 0x3944, 0x172c },    /* part_flip_scissors */
        .settle = { 0x02b0, 0x0000 },    /* part_hook_none_2b0 */
        .drive  = { 0x02b5, 0x0000 },    /* part_hook_no */
    },
    [KIND_SOLAR_PANEL] = {    /* DGROUP 0x1742 */
        ...
        .hit    = { 0x0297, 0x0000 },    /* part_hook_yes */
        .step   = { 0x3e08, 0x172c },    /* part_step_solar_panel */
        .setup  = { 0x3de5, 0x172c },    /* part_setup_solar_panel */
        .flip   = { 0x02ab, 0x0000 },    /* part_hook_none_2ab */
        .settle = { 0x02b0, 0x0000 },    /* part_hook_none_2b0 */
        .drive  = { 0x02b5, 0x0000 },    /* part_hook_no */
    },
    [KIND_TRAMPOLINE] = {    /* DGROUP 0x177c */
        ...
        .hit    = { 0x3ebf, 0x172c },    /* part_hit_trampoline */
        .step   = { 0x3fae, 0x172c },    /* part_step_trampoline */
        .setup  = { 0x3f72, 0x172c },    /* part_setup_trampoline */
        .flip   = { 0x02ab, 0x0000 },    /* part_hook_none_2ab */
        .settle = { 0x02b0, 0x0000 },    /* part_hook_none_2b0 */
        .drive  = { 0x02b5, 0x0000 },    /* part_hook_no */
    },
    [KIND_WINDMILL] = {    /* DGROUP 0x17b6 */
        ...
        .hit    = { 0x0297, 0x0000 },    /* part_hook_yes */
        .step   = { 0x49a1, 0x172c },    /* part_step_windmill */
        .setup  = { 0x496f, 0x172c },    /* part_setup_windmill */
        .flip   = { 0x4a22, 0x172c },    /* part_flip_windmill */
        .settle = { 0x02b0, 0x0000 },    /* part_hook_none_2b0 */
        .drive  = { 0x02b5, 0x0000 },    /* part_hook_no */
    },
    [KIND_BLAST] = {    /* DGROUP 0x17f0 */
        ...
        .hit    = { 0x0297, 0x0000 },    /* part_hook_yes */
        .step   = { 0x1649, 0x172c },    /* part_step_1649 */
        .setup  = { 0x02a6, 0x0000 },    /* part_hook_none_2a6 */
        .flip   = { 0x02ab, 0x0000 },    /* part_hook_none_2ab */
        .settle = { 0x02b0, 0x0000 },    /* part_hook_none_2b0 */
        .drive  = { 0x02b5, 0x0000 },    /* part_hook_no */
    ...
    [KIND_MORT_THE_MOUSE] = {    /* DGROUP 0x182a */
        ...
        .hit    = { 0x34b5, 0x172c },    /* part_hit_mort_the_mouse */
        .step   = { 0x34d0, 0x172c },    /* part_step_mort_the_mouse */
        .setup  = { 0x346f, 0x172c },    /* part_setup_mort_the_mouse */
        .flip   = { 0x35c7, 0x172c },    /* part_flip_mort_the_mouse */
        .settle = { 0x02b0, 0x0000 },    /* part_hook_none_2b0 */
        .drive  = { 0x02b5, 0x0000 },    /* part_hook_no */
    },
    [KIND_CANNON_BALL] = {    /* DGROUP 0x1864 */
        ...
        .hit    = { 0x0297, 0x0000 },    /* part_hook_yes */
        .step   = { 0x02a1, 0x0000 },    /* part_hook_none_2a1 */
        .setup  = { 0x0065, 0x172c },    /* part_setup_cannon_ball */
        .flip   = { 0x02ab, 0x0000 },    /* part_hook_none_2ab */
        .settle = { 0x02b0, 0x0000 },    /* part_hook_none_2b0 */
        .drive  = { 0x02b5, 0x0000 },    /* part_hook_no */
    },
    ...
    [KIND_CANDLE] = {    /* DGROUP 0x18d8 */
        ...
        .hit    = { 0x0297, 0x0000 },    /* part_hook_yes */
        .step   = { 0x098a, 0x172c },    /* part_step_candle */
        .setup  = { 0x0950, 0x172c },    /* part_setup_candle */
        .flip   = { 0x02ab, 0x0000 },    /* part_hook_none_2ab */
        .settle = { 0x02b0, 0x0000 },    /* part_hook_none_2b0 */
        .drive  = { 0x02b5, 0x0000 },    /* part_hook_no */
    },
    ...
    [KIND_CORNER_PIPE] = {    /* DGROUP 0x194c */
        ...
        .hit    = { 0x0297, 0x0000 },    /* part_hook_yes */
        .step   = { 0x02a1, 0x0000 },    /* part_hook_none_2a1 */
        .setup  = { 0x377b, 0x172c },    /* part_setup_corner_pipe */
        .flip   = { 0x37e5, 0x172c },    /* part_flip_corner_pipe */
        .settle = { 0x02b0, 0x0000 },    /* part_hook_none_2b0 */
        .drive  = { 0x02b5, 0x0000 },    /* part_hook_no */
    },
    ...
    [KIND_MOTOR] = {    /* DGROUP 0x19fa */
        ...
        .hit    = { 0x0297, 0x0000 },    /* part_hook_yes */
        .step   = { 0x13c9, 0x172c },    /* part_step_motor */
        .setup  = { 0x1435, 0x172c },    /* part_setup_motor */
        .flip   = { 0x149b, 0x172c },    /* part_flip_motor */
        .settle = { 0x02b0, 0x0000 },    /* part_hook_none_2b0 */
        .drive  = { 0x02b5, 0x0000 },    /* part_hook_no */
    },
    [51] = {    /* DGROUP 0x1a34 */
    ...
    [KIND_55] = {    /* DGROUP 0x1b1c */
        ...
        .hit    = { 0x0297, 0x0000 },    /* part_hook_yes */
        .step   = { 0x02a1, 0x0000 },    /* part_hook_none_2a1 */
        .setup  = { 0x1105, 0x172c },    /* part_setup_1105 */
        .flip   = { 0x02ab, 0x0000 },    /* part_hook_none_2ab */
        .settle = { 0x02b0, 0x0000 },    /* part_hook_none_2b0 */
        .drive  = { 0x02b5, 0x0000 },    /* part_hook_no */
    },
    [KIND_56] = {    /* DGROUP 0x1b56 */
        ...
        .hit    = { 0x0297, 0x0000 },    /* part_hook_yes */
        .step   = { 0x02a1, 0x0000 },    /* part_hook_none_2a1 */
        .setup  = { 0x10b6, 0x172c },    /* part_setup_10b6 */
        .flip   = { 0x02ab, 0x0000 },    /* part_hook_none_2ab */
        .settle = { 0x02b0, 0x0000 },    /* part_hook_none_2b0 */
        .drive  = { 0x02b5, 0x0000 },    /* part_hook_no */
    },
    [KIND_57] = {    /* DGROUP 0x1b90 */
        ...
        .hit    = { 0x0297, 0x0000 },    /* part_hook_yes */
        .step   = { 0x11a6, 0x172c },    /* part_step_11a6 */
        .setup  = { 0x1105, 0x172c },    /* part_setup_1105 */
        .flip   = { 0x02ab, 0x0000 },    /* part_hook_none_2ab */
        .settle = { 0x02b0, 0x0000 },    /* part_hook_none_2b0 */
        .drive  = { 0x11d2, 0x172c },    /* part_drive_11d2 */
    },
};

/*
 * OURS: the loader's half of the table above. DOS put these bytes in place and
 * patched their segments when it loaded the program; the port does both here,
 * once, before anything reads a kind. The segment is relocated the way
 * `io_load_program` relocates every other one - by the load segment, which is
 * where `IMAGE_BASE` says the image starts. `tools/check_part_kinds.py` proves
 * the result is byte for byte what the loader leaves in DGROUP.
 */
void load_part_kinds(void)
{
    uint16_t load_seg = (uint16_t)(IMAGE_BASE >> 4);
    int16_t k;

    for (k = 0; k < PART_KIND_COUNT; k++) {
        struct part_kind *rec = &PART_KINDS[k];

        *rec = PART_KINDS_IMAGE[k];
        rec->hit.seg    = (uint16_t)(rec->hit.seg + load_seg);
        rec->step.seg   = (uint16_t)(rec->step.seg + load_seg);
        rec->setup.seg  = (uint16_t)(rec->setup.seg + load_seg);
        rec->flip.seg   = (uint16_t)(rec->flip.seg + load_seg);
        rec->settle.seg = (uint16_t)(rec->settle.seg + load_seg);
        rec->drive.seg  = (uint16_t)(rec->drive.seg + load_seg);
    }
}
